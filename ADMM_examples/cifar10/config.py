    ...
    def __init__(self, args):
        ...
        if self.stage == 'retrain':
            ...
            if self.arch == "resnet18_adv":
                self.load_model = "resnet18_pretrained_qi.pth.tar"
            elif self.arch == "wrn_28_4":
                # self.load_model = "wrn284_pretrained_qi.pth.tar"
                self.load_model = "wrn284_pretrained.pth.tar"
            elif self.arch == "vgg16":
                self.load_model = "vgg16_pretrained_qi.pth.tar"
        else:
        ...
        strategies = json.load(open("strategies_harp_CIFAR10.json"))
