...
parser.add_argument('--arch', type=str, default='', help="select the model arch", choices = ['vgg16', 'resnet18_adv','wrn_28_4'], required=True)
parser.add_argument('--uniform', action='store_true', help="set if uniform pruning is desired")
parser.add_argument('--sparsity_type', type=str, default='', choices=["column", "weight"], required=True, help="Set sparsity type")
