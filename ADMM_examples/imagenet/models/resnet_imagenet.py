...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, conv_layer, stride=1, downsample=None, groups=1,
        ...
        self.conv2 = nn.Conv2d(inplanes, planes, kernel_size=3, stride=stride, padding=1, groups=1, bias=False)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, conv_layer, stride=1, downsample=None, groups=1,
        ...
        self.conv1 = nn.Conv2d(inplanes, width, kernel_size=1, stride=1, padding=0, dilation=1, bias=False)
        self.bn1 = norm_layer(width)
        self.conv2 = nn.Conv2d(width, width, kernel_size=3, stride=stride, padding=1, groups=1, bias=False)
        self.bn2 = norm_layer(width)
        self.conv3 = nn.Conv2d(width, planes * self.expansion, kernel_size=1, stride=1, padding=0, dilation=1, bias=False)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                nn.Conv2d(self.inplanes, planes * block.expansion, kernel_size=1, stride=stride, padding=0, bias=False, dilation=1),
...
def resnet50(**kwargs):
    return ResNet(nn.Conv2d, nn.Linear, Bottleneck, [3, 4, 6, 3], **kwargs)